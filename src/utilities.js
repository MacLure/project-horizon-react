...
export const formattedDate = (date) => new Date(Date.parse(date)).toLocaleString("en", optins)
...
// submission comments
new Date(Date.parse(comment.created_at)).toLocaleString("en", options);

// assignment details
formattedDate = new Date(
  Date.parse(this.props.assignment.due_date)
